...
<body>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">8.1.1 Identify situations of unethical professional conduct and propose ethical alternatives </a>
      </div>
    </div>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">8.2.1 Identify tenets of the ASME professional code of ethics</a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">8.2.2 Examine and apply moral & ethical principles to known case studies</a>
      </div>
    </div>
  </div>
...
if (isset($_POST['map_data'])) {
    ...
    for ($i = 1; $i <= $total_count; $i++) {
        ...
        if ($check_result && mysqli_num_rows($check_result) > 0) {
            ...
            $update_query = "UPDATE mapping SET PO8 = ? WHERE co_id = ? AND year = ? AND subject_id = ?";
            ...
            $insert_query = "INSERT INTO mapping (PO8, co_id, year, subject_id) VALUES (?, ?, ?, ?)";
