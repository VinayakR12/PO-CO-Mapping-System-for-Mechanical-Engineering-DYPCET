  ...
  <div class="cont mt-0" sty>
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">10.1.1 Read, understand and interpret technical and non-technical information </a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">10.1.2 Produce clear, well-constructed, and well-supported written engineering documents </a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">10.1.3 Create flow in a document or presentation - a logical progression of ideas so that the main point is clear</a>
      </div>
    </div>

    <div class="dropdown">
      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        10.2: Demonstrate competance in listening, speaking, and presentation
      </button>
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">10.2.1 Listen to and comprehend information, instructions, and viewpoints of others</a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">10.2.2 Deliver effective oral presentations to technical and non-technical audiences</a>
      </div>
    </div>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">10.3.1 Create engineering-standard figures, reports and drawings to complement writing and presentations</a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">10.3.2 Use a variety of media effectively to convey a message in a document or a presentation</a>
      </div>
    </div>
  </div>
...
if (isset($_POST['map_data'])) {
    ...
    for ($i = 1; $i <= $total_count; $i++) {
        ...
        if (!empty($_POST[$input_id])) {
            $input_value = round($_POST[$input_id] * 3 / 7);
        } else {
            $input_value = "";
        }
        ...
        if ($check_result && mysqli_num_rows($check_result) > 0) {
            ...
            $update_query = "UPDATE mapping SET PO10 = ? WHERE co_id = ? AND year = ? AND subject_id = ?";
            ...
            $insert_query = "INSERT INTO mapping (PO10, co_id, year, subject_id) VALUES (?, ?, ?, ?)";
