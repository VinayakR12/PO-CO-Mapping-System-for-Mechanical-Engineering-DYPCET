...
<body>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">9.1.1 Recognize a variety of working and learning preferences; appreciate the value of diversity on a team </a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">9.1.2 Implement the norms of practice (e.g. rules, roles, charters, agendas, etc.) of effective team work, to accomplish a goal. </a>
      </div>
    </div>

    <div class="dropdown">
      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        9.2: Demonstrate effective individual and team operations- communication, problem solving, conflict resolving, and leadership skills
      </button>
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">9.2.1 Demonstrate effective communication, problem-solving, conflict resolution and leadership skills</a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">9.2.2 Treat other team members respectfully</a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">9.2.3 Listen to other members</a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">9.2.4 Maintain composure in difficult situations</a>
      </div>
    </div>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">9.3.1 Present results as a team, with smooth integration of contributions from all individual efforts</a>
      </div>
    </div>
  </div>
...
if (isset($_POST['map_data'])) {
    ...
    for ($i = 1; $i <= $total_count; $i++) {
        ...
        if ($check_result && mysqli_num_rows($check_result) > 0) {
            ...
            $update_query = "UPDATE mapping SET PO9 = ? WHERE co_id = ? AND year = ? AND subject_id = ?";
            ...
            $insert_query = "INSERT INTO mapping (PO9, co_id, year, subject_id) VALUES (?, ?, ?, ?)";
