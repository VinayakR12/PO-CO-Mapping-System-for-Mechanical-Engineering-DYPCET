...
<body>
    ...
    <div class="dropdown">
      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        6.1: Demonstrate an ability to describe engineering roles in a broader context, pertaining to environment, health, safety, legal and public welfare.
      </button>
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">6.1.1 Identify and describe various engineering roles; particularly as pertains to protection of the public and public interest at the global, regional and local level</a>
      </div>
    </div>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">6.2.1 Interpret legislation, regulations, codes, and standards relevant to your discipline and explain its contribution to the protection of the public</a>
      </div>
    </div>
  </div>
...
if (isset($_POST['map_data'])) {
    ...
    for ($i = 1; $i <= $total_count; $i++) {
        ...
        if (!empty($_POST[$input_id])) {
            $input_value = round($_POST[$input_id] * 3 / 2);
        } else {
            $input_value = "";
        }
        ...
        if ($check_result && mysqli_num_rows($check_result) > 0) {
            ...
            $update_query = "UPDATE mapping SET PO6 = ? WHERE co_id = ? AND year = ? AND subject_id = ?";
            ...
            $insert_query = "INSERT INTO mapping (PO6, co_id, year, subject_id) VALUES (?, ?, ?, ?)";
