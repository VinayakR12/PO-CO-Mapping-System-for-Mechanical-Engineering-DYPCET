    ...
    <div class="cont mt-0" sty>
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.1.1 Articulate problem statements and identify objectives</a>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.1.2 Identify engineering systems, variables, and parameters to solve the problems</a>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.1.3 Identify the mathematical, engineering and other relevant knowledge that applies to a given problem </a>
            </div>
        </div>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.2.1 Reframe complex problems into interconnected sub-problems</a>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.2.2 Identify, assemble and evaluate information and resources</a>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.2.3 Identify existing processes/solution methods for solving the problem, including forming justified approximations and assumptions</a>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.2.4 Compare and contrast alternative solution processes to select the best process.</a>
            </div>
        </div>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.3.1 Combine scientific principles and engineering concepts to formulate model/s (mathematical or otherwise) of a system or process that is appropriate in terms of applicability and required accuracy.</a>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.3.2 Identify assumptions (mathematical and physical) necessary to allow modeling of a system at the level of accuracy required.</a>
            </div>
        </div>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.4.1 Apply engineering mathematics and computations to solve mathematical models</a>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.4.2 Produce and validate results through skilful use of contemporary engineering tools and models</a>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.4.3 Identify sources of error in the solution process, and limitations of the solution.</a>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">2.4.4 Extract desired understanding and conclusions consistent with objectives and limitations of the analysis </a>
            </div>
        </div>
    </div>
...
if (isset($_POST['map_data'])) {
    ...
    for ($i = 1; $i <= $total_count; $i++) {
        ...
        if ($check_result && mysqli_num_rows($check_result) > 0) {
            ...
            $update_query = "UPDATE mapping SET PO2 = ? WHERE co_id = ? AND year = ? AND subject_id = ?";
            ...
            $insert_query = "INSERT INTO mapping (PO2, co_id, year, subject_id) VALUES (?, ?, ?, ?)";
