...
<body>
  ...
  <div>
    <div class="pso-comp">
      <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">Demonstrate an ability to define a complex/open ended problem in thermal engineering by using relevant engineering codes and standards.</a>

    </div>
    <div class="pso-comp">
    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">Demonstrate an ability to conduct investigation and solve technical issues in thermal systems. </a>

    </div>
    <div class="pso-comp">
    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">Apply management principles to solve organizational problems. </a>
  ...
  if (isset($_POST['map_data'])) {
    ...
    for ($i = 1; $i <= $total_count; $i++) {
      ...
      if (!empty($_POST[$input_id])) {
        $input_value = round($_POST[$input_id] * 3 / 3);
      } else {
        $input_value = "";
      }
      ...
      if ($check_result && mysqli_num_rows($check_result) > 0) {
        ...
        $update_query = "UPDATE mapping SET PSO2 = ? WHERE co_id = ? AND year = ? AND subject_id = ?";
        ...
        $insert_query = "INSERT INTO mapping (PSO2, co_id, year, subject_id) VALUES (?, ?, ?, ?)";
