...
<body>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">12.1.1 Describe the rationale for the requirement for continuing professional development </a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">12.1.2 Identify deficiencies or gaps in knowledge and demonstrate an ability to source information to close this gap</a>
      </div>
    </div>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">12.2.1 Identify historic points of technological advance in engineering that required practitioners to seek education in order to stay current</a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">12.2.2 Recognize the need and be able to clearly explain why it is vitally important to keep current regarding new developments in your field</a>
      </div>
    </div>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">12.3.1 Source and comprehend technical literature and other credible sources of information</a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">12.3.2 Analyze sourced technical and popular information for feasibility, viability, sustainability, etc.</a>
      </div>
    </div>
...
if (isset($_POST['map_data'])) {
    ...
    for ($i = 1; $i <= $total_count; $i++) {
        ...
        if ($check_result && mysqli_num_rows($check_result) > 0) {
            ...
            $update_query = "UPDATE mapping SET PO12 = ? WHERE co_id = ? AND year = ? AND subject_id = ?";
            ...
            $insert_query = "INSERT INTO mapping (PO12, co_id, year, subject_id) VALUES (?, ?, ?, ?)";
