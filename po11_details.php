...
<body>
    ...
    <div class="dropdown">
      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        11.1: Demonstrate an ability to evaluate the economics and financial performance of an engineering activity
    </button>
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">11.1.1 Describe various economic and financial costs/benefits of an engineering activity </a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">11.1.2 Analyze different forms of financial statements to evaluate the financial status of an engineering project </a>
      </div>
    </div>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">11.2.1 Analyze and select the most appropriate proposal based on economic and financial considerations.</a>
      </div>
    </div>

    <div class="dropdown">
      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        11.3: Demonstrate an ability to plan/manage an engineering activity within time and budget constraint
      </button>
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">11.3.1 Identify the tasks required to complete an engineering activity, and the resources required to complete the tasks.</a>
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">11.3.2 Use project management tools to schedule an engineering project, so it is completed on time and on budget.</a>
      </div>
    </div>
...
if (isset($_POST['map_data'])) {
    ...
    for ($i = 1; $i <= $total_count; $i++) {
        ...
        if ($check_result && mysqli_num_rows($check_result) > 0) {
            ...
            $update_query = "UPDATE mapping SET PO11 = ? WHERE co_id = ? AND year = ? AND subject_id = ?";
            ...
            $insert_query = "INSERT INTO mapping (PO11, co_id, year, subject_id) VALUES (?, ?, ?, ?)";
