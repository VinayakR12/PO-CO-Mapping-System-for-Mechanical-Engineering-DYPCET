    ...
    <div class="cont mt-0" sty>
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">1.1.1 Apply mathematical techniques such as calculus, linear algebra, and statistics to solve problems</a>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">1.1.2 Apply advanced mathematical techniques to model and solve mechanical engineering problems</a>
            </div>
        </div>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">1.2.1 Apply laws of natural science to an engineering problem</a>
            </div>
        </div>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">1.3.1 Apply fundamental engineering concepts to solve engineering problems</a>
            </div>
        </div>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal1">1.4.1 Apply Mechanical engineering concepts to solve engineering problems.</a>
            </div>
        </div>
    </div>
    ...
    <form method="post">
        <div class="map">
            ...
            if (isset($_GET['course_id'])) {
                ...
                for ($i = 1; $i <= $total_count; $i++) {
                    $input_id = "input_$i";
                    echo "<input type='hidden' id='$input_id' name='$input_id' class='input_1' value='0'><br>";
                }
            }
            ?>
            <center>
...
if (isset($_POST['map_data'])) {
    ...
    for ($i = 1; $i <= $total_count; $i++) {
        ...
        if ($check_result && mysqli_num_rows($check_result) > 0) {
            ...
            $update_query = "UPDATE mapping SET PO1 = ? WHERE co_id = ? AND year = ? AND subject_id = ?";
            ...
            $insert_query = "INSERT INTO mapping (PO1, co_id, year, subject_id) VALUES (?, ?, ?, ?)";
